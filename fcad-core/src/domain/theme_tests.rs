...
mod tests {
    ...
    fn test_luminance_black() {
        ...
        assert!((l - 0.0).abs() < 0.001, "Black should have luminance ~0.0, got {}", l);
    }
    ...
    fn test_luminance_white() {
        ...
        assert!((l - 1.0).abs() < 0.001, "White should have luminance ~1.0, got {}", l);
    }
    ...
    fn test_luminance_red() {
        ...
        assert!((l - 0.2126).abs() < 0.01, "Red should have luminance ~0.2126, got {}", l);
    }
    ...
    fn test_contrast_ratio_black_white() {
        ...
        assert!((cr - 21.0).abs() < 0.1, "Black vs white should be ~21:1, got {}", cr);
    }
    ...
    fn test_adapt_black_on_black_background() {
        ...
        assert_ne!(adapted, "#000000", "Black on black must be adapted to avoid invisibility");
    }
    ...
    fn test_adapt_red_on_black_background() {
        ...
        assert_eq!(adapted, "#FF0000", "Red on black has sufficient contrast, should remain unchanged");
    }
    ...
    fn test_adapt_black_on_white_background() {
        ...
        let adapted = theme.adapt_layer_color("#000000");
        assert_eq!(adapted, "#000000", "Black on white has sufficient contrast, should remain unchanged");
    }
    ...
    fn test_adapt_white_on_white_background() {
        ...
        assert_ne!(adapted, "#FDFDFB", "White on white must be adapted to avoid invisibility");
    }
    ...
    fn test_adapt_cyan_on_black_background() {
        ...
        assert_eq!(adapted, "#00FFFF", "Cyan on black has sufficient contrast, should remain unchanged");
    }
}
