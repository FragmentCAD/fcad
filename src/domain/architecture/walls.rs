...
pub fn generate_wall(world: &mut World, p1: Point2D, p2: Point2D, thickness: f64, layer_name: &str) {
    let dx = p2.x - p1.x;
    let dy = p2.y - p1.y;
...
mod tests {
    ...
    fn test_generate_parametric_wall() {
        ...
        assert_eq!(query.len(), 4, "Un muro rectangular debe resolverse en 4 líneas puras");
